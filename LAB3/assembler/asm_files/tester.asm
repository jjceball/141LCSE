...
// Add unit test for left bitwise rotate instruction
// Test for LBR
.const %LBR_ANS   , 0x00000002
.const %LBR_A     , 0x00000001
.const %LBR_B     , 0x00000001
MOV    $R7, %LBR_A
MOV    $R2, %LBR_B
LBR    $R7, $R2
MOV   $R6,%LBR_ANS
...
// New unit tests for added instructions

// Test for XOR
.const %XOR_A     , 0x00000000
.const %XOR_B     , 0x00000001
MOV    $R7, %XOR_A
MOV    $R2, %XOR_B
XOR    $R7, $R2
MOV   $R6,%ONE
