...
MAJ:
   ...
   AND  $R6, $R3 // YZ
   AND  $R1, $R3 // XZ
   XOR  $R1, $R5 // 2nd Change
   XOR  $R1, $R6 // 3rd Change
   MOV  $R4, $R1
   JALR $R31, $R30
...
BIGSIG0:
    ...
    ADDU $R8, %S11
	ROTR $R9, $R8
    XOR  $R9, $R4 // 4th Change
    XOR  $R9, $R3 // 5th Change
    MOV  $R2, $R9
    JALR $R31, $R30
...
BIGSIG1:
    ...
    ADDU $R8, %S7
	ROTR $R9, $R8
    XOR  $R9, $R4 // 6th Change
    XOR  $R9, $R3 // 7th Change
    MOV  $R2, $R9
    JALR $R31, $R30
...
SMSIG0:
    ...
    MOV  $R9, $R1
	ROTR $R9, %S18
    XOR  $R9, $R3 // 8th Change
    MOV  $R8, $R1
    SRLV $R8, %S3
	XOR  $R9, $R8 // 9th Change
    MOV  $R2, $R9
    JALR $R31, $R30
