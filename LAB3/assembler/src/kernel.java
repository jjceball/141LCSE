...
class kernel{
	...
	public static void initialization() throws IOException {
		...
		//New instructions for bitcoin mining
		opcodeTable.put("XOR"  , "11100");
		opcodeTable.put("ROTR" , "11110");
		//New instructions for Lab3
		opcodeTable.put("SIG0" , "01111");
		opcodeTable.put("SIG1" , "10100");
		opcodeTable.put("SSIG0", "10101");
		opcodeTable.put("SSIG1", "10110");
	}
  ...
  /** Converts the intrucion to binary machine code. */
	String generateCode(Instruction instruction) {
		...
		switch(opcodes.toOpcode(operator)) {
            ...
            case SB:
            case MOV:
			// New instructions added for bitcoin mining 
			case LBR:
			case XOR:
			case ROTR:
			case SIG0:
